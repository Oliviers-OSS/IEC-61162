...
#ifndef AIVDOTESTS_H_
#define AIVDOTESTS_H_
...
class AIVDO_Tests: public CxxTest::TestSuite {
    IEC61162::AIVDOMessage msg;
    bool callbackCalled;
...
public:
    ...
    AIVDO_Tests():msg(this),callbackCalled(false),currentMsg(0),lastHandlerTestResult(EXIT_SUCCESS) {
