...
#ifndef _AIS_MESSAGE_3_H_
#define _AIS_MESSAGE_3_H_
...
namespace IEC61162 {
    ...
    class AISMessage3;
    typedef basic_smart_pointer<AISMessage3>    AISMsg3;
    ...
    public:
         ...
         * @return basic_smart_pointer object containing an AISMessage3 object if the error code is EXIT_SUCCESS
         */
        static AISMsg3 build(const unsigned char *payload,int &error);
    };
} // namespace IEC61162

#endif /* _AIS_MESSAGE_3_H_ */
