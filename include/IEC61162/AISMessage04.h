/*
 * AISMessage4.h
 * Base station report, cf. R-REC-M.1371-4-201004-E p103
 *  Created on: 1 avr. 2013
 *      Author: oc
 */

#ifndef _AIS_MESSAGE_4_H_
#define _AIS_MESSAGE_4_H_
...
namespace IEC61162 {
    ...
    class AISMessage4;
    typedef basic_smart_pointer<AISMessage4>    AISMsg4;
    ...
    public:
         ...
         * @return basic_smart_pointer object containing an AISMessage4 object if the error code is EXIT_SUCCESS
         */
        static AISMsg4 build(const unsigned char *payload,int &error);
    };
} //namespace IEC61162


#endif /* _AIS_MESSAGE_4_H_ */
