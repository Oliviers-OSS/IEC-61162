/*
 * AISMessage07.h
 * Binary acknowledge, cf. R-REC-M.1371-4-201004-E p109
 *  Created on: 5 avr. 2013
 *      Author: oc
 */

#ifndef _AIS_MESSAGE_7_H_
#define _AIS_MESSAGE_7_H_
...
namespace IEC61162 {
    ...
    class AISMessage7;
    typedef basic_smart_pointer<AISMessage7>    AISMsg7;
    ...
    public:
         ...
         * @return basic_smart_pointer object containing an AISMessage7 object if the error code is EXIT_SUCCESS
         */
         static AISMsg7 build(const unsigned char *payload,const size_t payloadSize,int &error);
    };

} // namespace IEC61162

#endif /* _AIS_MESSAGE_7_H_ */
