...
#ifndef _AIS_MESSAGE_2_H_
#define _AIS_MESSAGE_2_H_
...
namespace IEC61162 {
    ...
    class AISMessage2;
    typedef basic_smart_pointer<AISMessage2>    AISMsg2;
    ...
    public:
         ...
         * @return basic_smart_pointer object containing an AISMessage2 object if the error code is EXIT_SUCCESS
         */
        static AISMsg2 build(const unsigned char *payload,int &error);
    };
} // namespace IEC61162

#endif /* _AIS_MESSAGE_2_H_ */
